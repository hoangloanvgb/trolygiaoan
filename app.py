...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Loan - Trường TH Trần Quốc Toản - ĐT: 0967194109</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Loan - Trường TH Trần Quốc Toản - ĐT: 0967194109 </div>", unsafe_allow_html=True)
